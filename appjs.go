...
const appJSTemplate = `(function () {
  ...
  var I18N = {
    es: {
      ...
      feat1d: 'Relampo detecta y correlaciona los valores dinámicos por vos al grabar: menos scripting manual, pruebas listas antes.',
      feat2t: '500 usuarios virtuales, 4 nodos',
      feat2d: 'Generá hasta 500 usuarios virtuales distribuidos en 4 nodos de carga con la integración nativa de Relampo con GitHub.',
      feat3t: 'Scripts YAML declarativos',
      feat3d: 'Fáciles de leer, intuitivos y versionables en Git: revisás tus pruebas de performance como revisás código.',
      ...
      featLink: 'Conocé más en relampo.com →',
