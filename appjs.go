...
const appJSTemplate = `(function () {
  ...
  var I18N = {
    es: {
      ...
      footer: 'RelampoTickets — app de práctica para correlación en pruebas de rendimiento',
      homeTitle: 'Entradas para tus eventos,', homeTitleHl: 'a la velocidad del rayo',
      homeSub: 'Inicia sesión para comprar entradas.',
      loginTitle: 'Iniciar sesión', userLabel: 'Usuario', passLabel: 'Contraseña',
      userPh: 'usuario', passPh: 'contraseña', loginBtn: 'Entrar',
      featHead: '¿Por qué Relampo?',
      feat1t: 'Correlación automática completa',
      feat1d: 'Relampo detecta y correlaciona los valores dinámicos por ti al grabar: menos scripting manual, pruebas listas antes.',
      feat2t: '500 usuarios virtuales, 4 nodos',
      feat2d: 'Genera hasta 500 usuarios virtuales distribuidos en 4 nodos de carga con la integración nativa de Relampo con GitHub.',
      feat3t: 'Scripts YAML declarativos',
      feat3d: 'Fáciles de leer, intuitivos y versionables en Git: revisas tus pruebas de rendimiento como revisas código.',
      feat4t: 'Motor de carga en Go',
      feat4d: 'Generación de carga de alto rendimiento con la eficiencia y la concurrencia nativa de Go.',
      featLink: 'Conoce más en relampo.com →',
      eventsTitle: 'Elige tu', eventsTitleHl: 'evento', eventsHello: 'Hola',
      ...
      manageSub: 'Crea tus propios eventos: aparecen en el catálogo y se pueden comprar.',
      ...
      cbBadge: 'RelampoPay — confirmación', cbTitle: 'Revisa tu', cbTitleHl: 'compra',
      ...
      jsReserved: 'Asiento reservado. Tienes 1 minuto para completar el pago.',
      ...
      jsNoEvents: 'Todavía no has publicado eventos. Crea el primero con el formulario de arriba.',
      jsEdit: 'editar', jsDelete: 'borrar', jsLoading: 'Cargando…',
      limitNote: 'Has alcanzado el límite de 5 eventos. Borra alguno para poder crear otro.'
    },
    en: {
      ...
      featHead: 'Why Relampo?',
      feat1t: 'Full automatic correlation',
      feat1d: 'Relampo detects and correlates dynamic values for you while recording: less manual scripting, tests ready sooner.',
      feat2t: '500 virtual users, 4 nodes',
      feat2d: 'Generate up to 500 virtual users distributed across 4 load nodes with Relampo’s native GitHub integration.',
      feat3t: 'Declarative YAML scripts',
      feat3d: 'Easy to read, intuitive and Git-versionable: review your performance tests the way you review code.',
      feat4t: 'Go-powered load engine',
      feat4d: 'High-performance load generation with Go’s efficiency and native concurrency.',
      featLink: 'Learn more at relampo.com →',
